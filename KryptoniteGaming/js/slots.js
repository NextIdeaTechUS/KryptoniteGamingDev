...
symbols.src = "../images/slots/slot_icons.png";
reels_bg.src = "../images/slots/reels_bg.png";

machine.src = "../images/slots/machine.png";
...
var row_count = 3;
var stopping_distance = 1650;
var max_reel_speed = 100;
...
var reel_area_left = 100;
var reel_area_top = 132;
var reel_area_width = 300;
var reel_area_height = 300;
...
for (var i=0; i<reel_count; i++) {
    ...
    console.log("Starting position " + i + ": " + reel_position[i]);
}
...
function render_reel() {
    ...
    try {
        ...
        // Add the overlay
        ctx.drawImage(machine, 0, 10);

    }
    catch (ex) {

        console.log("Error while rendering: " + ex.message);
    }
    ...
    if (start_slowing[i] == false) {
      ...
      if (i == 0) check_position = true;
        ...
        if (check_position) {
            ...
            //console.log("Stopping: " + stopping_position[i]);
...
function logic_reward() {
  ...
  payout--;
  credits++;
  cred_p.innerHTML = "Winnings (" + credits + ")";
...
function spin(line_choice) {
  ...
  cred_p.innerHTML = "Winning (" + credits + ")";
  log_p.innerHTML = "";
